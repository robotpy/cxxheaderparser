...
from cxxheaderparser.types import DecltypeSpecifier
...
from cxxheaderparser.types import TemplateInst
from cxxheaderparser.types import TemplateNonTypeParam
        ...
        namespace=NamespaceScope(
            classes=[
                ...
                ClassScope(
                    class_decl=ClassDecl(
                        typename=PQName(
                            segments=[NameSpecifier(name="S2")],
                            classkey="struct",
                        ),
                        template=TemplateDecl(
                            params=[
    ...
    assert data == ParsedData(
        namespace=NamespaceScope(
            forward_decls=[
                ForwardDecl(
                    typename=PQName(
                        segments=[NameSpecifier(name="My_vector")],
                        classkey="class",
                    ),
                ...
                ForwardDecl(
                    typename=PQName(
                        segments=[NameSpecifier(name="My_tuple")],
                        classkey="class",
                    ),
                    template=TemplateDecl(
    ...
    assert data == ParsedData(
        namespace=NamespaceScope(
            ...
            forward_decls=[
                ForwardDecl(
                    typename=PQName(
                        segments=[NameSpecifier(name="eval")],
                        classkey="struct",
                    ),
                    template=TemplateDecl(
                            ...
                            parameters=[
                                Parameter(
                                    type=Type(
                                        typename=PQName(
                                            segments=[
                                                FundamentalSpecifier(name="bool"),
                                            ],
                                        ),
                                    ),
                                    name="flag",
        ...
        namespace=NamespaceScope(
            classes=[
                ClassScope(
                    class_decl=ClassDecl(
                        typename=PQName(
                            segments=[NameSpecifier(name="XYZ")],
                            classkey="class",
                        ),
                        bases=[
                            BaseClass(
